...
const FundingChartSection = () => {
  ...
  return (
    <section className="text-neutral-100" id="funding-section">
      <div className="container max-w-2xl md:max-w-7xl mx-auto ">
        <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-center md:pb-16">
          {/* Chart Column */}
          <div
            className="w-full flex flex-col items-center justify-center md:mb-0 md:col-span-4 min-h-[320px] h-auto"
            data-aos="fade-right"
          >
            {/* Pie chart */}
          ...
          <div className="w-full px-4 md:px-8 mb-8 md:mb-0">
            <h3
              className="text-2xl md:text-3xl font-bold mb-6 tracking-tight text-blue-400"
              data-aos="fade-up"
            >
            ...
            <div
              ...
              data-aos-delay="100"
            >
              We are seeking strategic investors to help us scale operations,
              finalize critical R&D, and bring these transformative solutions to
              the global market.
            </div>
            <p
              className="text-base md:text-lg text-neutral-400 mb-6"
              data-aos="fade-up"
              data-aos-delay="200"
            >
              With funding, we will achieve these critical milestones within 4-6
              months:
            </p>
            <ul className="space-y-4 text-neutral-200">
              ...
              >
                ...
                <span>
                  ...
                  Complete and launch our proprietary fuel manufacturing system.
                </span>
              </li>
              <li
                className="flex items-start"
              ...
              >
                ...
                <span>
                  ...
                  Conduct rigorous test flights to validate performance and
                  safety.
                </span>
              </li>
              <li
              ...
              >
                ...
                <span>
                  ...
                  Secure and execute our first pilot program with a key partner.
                </span>
              </li>
            </ul>
          </div>
        ...
        <div
          className="pt-8 border-t border-neutral-700 px-4"
          data-aos="fade-up"
          data-aos-delay="200"
        >
            ...
            <div className="flex justify-between gap-2 items-center mb-4">
              <span className="text-lg font-semibold text-neutral-300">
                ...
                <span className="text-sm text-neutral-600">
                  By Lithuanian Armed Forces & European Union (EUDIS)
                </span>
              </span>
              <span className="text-lg text-nowrap font-semibold text-blue-400">
