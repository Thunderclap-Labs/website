...
const FundingChartSection = () => {
  ...
  const chartInstance = useRef(null); // To hold the chart instance for cleanup
  ...
  useEffect(() => {
    if (chartRef.current) {
      ...
      // Your provided funding data. Note: Percentages should ideally sum to 100.
      // An "Unallocated" slice was added to complete the chart.
      const fundingData = {
        labels: [
