...
```css
filter: drop-shadow(0 0 1px white) drop-shadow(0 0 24px white) drop-shadow(0 0 4px #97DFFC);
```
...
<div class="featured-card white-feature bg-neutral-600 bg-opacity-55 p-[1px] rounded-lg">
...
**Stat card:**
```html
<div class="featured-card white-feature bg-neutral-600 rounded-lg bg-opacity-55 p-[1px]">
  <div class="flex flex-col items-center justify-center p-6 bg-black bg-opacity-90 rounded-lg">
...
```html
<div class="featured-card white-feature bg-neutral-600 bg-opacity-55 p-[1px] rounded-lg">
  <div class="flex flex-col bg-black bg-opacity-95 p-8 items-center justify-center rounded-lg">
...
<Heading
  title="Page Title"
  subtitle="Page description text goes here."
/>
```
    ...
    <main>
      ...
      <section className="relative bg-black min-h-[60vh] flex items-center">
        ...
        <div className="relative z-[1] container max-w-7xl mx-auto px-4 py-32">
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-semibold" data-aos="fade-up">
            Page Title
          </h1>
          <p className="max-w-3xl text-lg md:text-3xl font-normal leading-relaxed text-neutral-300 mt-4" data-aos="fade-up" data-aos-delay="100">
