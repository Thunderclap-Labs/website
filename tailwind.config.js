    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "radial-gradient-layers":
          "radial-gradient(circle at top right, rgba(0, 0, 0, 1), transparent), radial-gradient(circle at 20% 80%, rgba(41, 196, 255, 0.13), transparent)",
      },
      animation: {
      ...
      keyframes: {
        "wheel-animation": {
          ...
          }, // Start transparent and slightly up
          "20%": {
            opacity: "1",
